...
export function Edite() {
    ...
    const edited = (e) => {
      e.preventDefault();
      console.log(newCard);
      // localStorage.setItem("createNewCard", JSON.stringify(newCard));
      // JSON.stringify(localStorage.setItem("createdImgs", newImg));
      navigate("/blog");
      ...
      <div>
        <div id="addNewProduct">
          <div id="card-create-new-product">
            <form id="form-add-product" onSubmit={edited}>
              <div>
